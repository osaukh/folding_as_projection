...
from utils.weight_clustering import axes2perm_to_perm2axes, align_weight_clustering
...
#     perm_to_axes = axes2perm_to_perm2axes(axes_to_perm)
#     param, perm_size = compress_weight_clustering(perm_to_axes, model_param, max_ratio, threshold, hooks=hooks,
#                                                   approx_repair=True, merge_layer=merge_layer)
#
#     for p in param.keys():
#         get_module_by_name(origin_model, p).data = param[p].data.clone().detach()
#
...
#
#
# def merge_channel_ResNet50_clustering_approx_repair_wider(origin_model, model_param, max_ratio=1., threshold=0.1,
#                                                           hooks=None, merge_layer=None):
#     max_ratio = 1.0 - max_ratio
...
#
#
# def merge_channel_ResNet18_big_clustering_approx_repair(origin_model, model_param, max_ratio=1., threshold=0.1,
#                                                         hooks=None):
#     max_ratio = 1.0 - max_ratio
